CorreiosECT.configure do |config|
  config.cnpj = '21075446000155'
  config.user = 'pedro.fausto@hotmail.com'
  config.password = 'an8bw4'
  config.administrative_code = '16332113'
  config.contract = '9912406220'
  config.code_service = ''
  config.card = '0072796901'
